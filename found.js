// ============================================================
//  found.js  —  Report Found Item  (Firebase Firestore version)
// ============================================================
...
document.getElementById("foundForm").addEventListener("submit", async function (e) {
  ...
  try {
    ...
    // ── Check for possible match in "lost" items ──────────
    const q = query(
      collection(db, "items"),
      where("type",     "==", "lost"),
      where("name",     "==", itemName),
